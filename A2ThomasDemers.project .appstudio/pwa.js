...
const cacheName = 'A2ThomasDemers_-2021-09-19 21:12:45.737805'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'A2ThomasDemers_'.length) === 'A2ThomasDemers_') {
